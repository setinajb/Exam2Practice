...
def run_test_practice_problem2a():
    ...
    print('Test Case 1')
    expected = [3, 7, 5, 10, 8]
    actual = practice_problem2a([0, 4, 2, 7, 5], 3)
    print('expected:', expected)
    print('actual:', actual)

    print('Test Case 2')
    expected = [102, 0, -3, 2]
    actual = practice_problem2a([100, -2, -5, 0], 2)
    print('expected:', expected)
    print('actual:', actual)

    print('Test Case 3')
    expected = [42, 5, -3, 2]
    actual = practice_problem2a([43, 6, -2, 3], -1)
    print('expected:', expected)
    print('actual:', actual)

    print('Test Case 4')
    expected = [37, 0, -1]
    actual = practice_problem2a([40, 3, 2], -3)
    print('expected:', expected)
    print('actual:', actual)
...
def practice_problem2a(sequence, delta):
    ...
    for k in range(len(sequence)):
        new_value = sequence[k] + delta
        sequence_2 = sequence_2 + [new_value]
    return sequence_2
